...
//
// Modified by Alex TC @TCRobotics for BricoLabs ESP8266 LoRa shield and SHT30 sensor shield
//
...
//////////////////////////////////////////////////////
  if(sht30.get()==0)
  {
    ...
    //see LoraCode.cpp
    tchars += lcode.eTemperature(temp, buf + tchars);
    tchars += lcode.eHumidity(hum, buf + tchars);
  ...
  {
    Serial.print("SHT30 shield error!");
    return(0);
  }

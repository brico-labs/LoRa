...
//
// Modified by Alex TC @TCRobotics for BricoLabs ESP8266 LoRa shield
// IRQ not working! (dio0 and dio1 disconnected), but seems to work ok :)
//
...
#define VERSION "V.5.3.2.H; 1800707a BricoLabs edition"
...
//	1: BricoLabs ESP8266 LoRa Shield
//	2: COMRESULT pin out
...
#define AP_NAME "BricoGateway"
#define AP_PASSWD "pulpiño"
...
#define _DESCRIPTION "BricoLabs ESP8266 868.1MHz SP7"			// Name of the gateway
#define _EMAIL "contacto@bricolabs.cc"		// Owner
#define _PLATFORM "ESP8266"
#define _LAT 43.377521
#define _LON -8.406366

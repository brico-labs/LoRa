...
//
struct pins {
	uint8_t dio0=0;	  //D4 GPIO0  Disconnected from the shield :( seems to work ok without it :)
	uint8_t dio1=2;	  //D4 GPIO2  Disconnected from the shield Used for CAD, may or not be shared with DIO0

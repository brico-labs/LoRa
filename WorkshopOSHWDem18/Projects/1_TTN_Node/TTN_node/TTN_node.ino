...
#define RFM95W_DI_OR D3   // GPIO0  -- RFM95W's IRQ(Interrupt Request) NOT USED! Pin not connected to ESP8266!
...
const lmic_pinmap lmic_pins = {
  ...
  .rst  = LMIC_UNUSED_PIN,
  .dio  = {RFM95W_DI_OR, RFM95W_DI_OR, RFM95W_DI_OR},
};
...
void setup() {
  Serial.begin(115200);
  Serial.println("BricoLabs ESP8266 LoRa shield node TTN");
